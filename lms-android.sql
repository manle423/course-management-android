...
--
-- Host: localhost
-- Generation Time: May 13, 2024 at 06:40 PM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_create_user` (IN `p_id` VARCHAR(255), IN `p_username` VARCHAR(255), IN `p_password` VARCHAR(255))   BEGIN
...
('39e17677-66f7-4342-9d25-bc22d65b0c12', 'admin', '$2b$10$KWHm35TAMp27qDX9hsYCnez9lQVv0U21ZvI0RmVFsVkEItxG4t/ty', 1, 3),
('4', 'user4', 'password4', 1, 1),
('5', 'user5', 'password5', 1, 2),
('6', 'user6', 'password6', 1, 3),
('7', 'user7', 'password7', 1, 1),
('8', 'user8', 'password8', 1, 2),
('8450d65a-9a82-4c32-94e8-9c28cbee6ce8', 'man', '$2b$10$b1BQxCF25zQeJAzKl23Y4eK7cS49AyauENPqOaMqdqFWd3cPn483C', 1, 3),
